...
```
llama-server --model C:/hf/DeepSeek-V4-Flash-0731-UD-Q8_K_XL.gguf --ctx-size 131072 --flash-attn on --parallel 1 --no-cont-batching --load-mode none --batch-size 4096 --ubatch-size 4096 --cache-type-k q8_0 --cache-type-v q8_0 --ctx-checkpoints 0 --threads 24 --threads-batch 24 --jinja --log-verbosity 4 --cache-reuse 256 --cache-ram -1 --swa-full --timeout 3600  --host 0.0.0.0 --port 8888 
```
