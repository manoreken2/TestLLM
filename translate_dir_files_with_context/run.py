...
def main():
    ...
    parser.add_argument("--model_name",         help="Model used on inference.",                  type=str, default="DeepSeek-R1:671b-0528-q8_0")
    parser.add_argument("--context_window",     help="Num of context tokens.",                    type=int, default=8000)
    parser.add_argument("--tgt_lang",           help="Target language name.",                     type=str, default="現代日本語")
    parser.add_argument("--q_text_limit",       help="Query text limit characters count.",        type=int, default=512)
    parser.add_argument("--num_thread",         help="Num of CPU worker thread.",                 type=int, default=15)
    ...
    parser.add_argument("--system_prompt",      help="system prompt message.",                    type=str, default='あなたは常に正確に回答する日本語アシスタントです。')
    ...
    parser.add_argument("--prompt", help="prompt text.", type=str, default="以下のtriplequoteで囲まれた文を{tgt_lang}に翻訳してください。翻訳後に解説を付けてください。ルビを出力しないでください。原文を出力しないでください。 ```{in_text}``` ")
